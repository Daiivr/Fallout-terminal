...
const INTEL_EMAIL_SUBSCRIBE_API_URL = "/api/intel/email-subscriptions";
const INTEL_EMAIL_SUBSCRIPTIONS_ME_API_URL = "/api/intel/email-subscriptions/me";
const INTEL_EMAIL_ADMIN_TEST_API_URL = "/api/admin/intel/email-test";
...
const FO76_EVENTS_FALLBACK_URL = "data/fo76-events-fallback.json";
