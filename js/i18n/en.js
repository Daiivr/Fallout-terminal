...
globalThis.FALLOUT_CODEX_LOCALES.en = {
    ...
    files_share_unauthorized_message_named: "You're trying to access \"{name}\". These files are available only to authorized users. Log in with an authorized Discord account to continue.",
